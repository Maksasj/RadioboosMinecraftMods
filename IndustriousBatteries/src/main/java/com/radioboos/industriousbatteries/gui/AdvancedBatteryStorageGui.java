...
import com.radioboos.adinfinitumcore.Utils;
...
public class AdvancedBatteryStorageGui extends GuiContainer {
    ...
    private final AdvancedBatteryStorageTileEntity entity;

    public AdvancedBatteryStorageGui(AdvancedBatteryStorageTileEntity entity, Container container) {
        super(container);
