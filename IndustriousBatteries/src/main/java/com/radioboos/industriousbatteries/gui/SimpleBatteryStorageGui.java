...
public class SimpleBatteryStorageGui extends GuiContainer {
    ...
    private final SimpleBatteryStorageTileEntity entity;

    public SimpleBatteryStorageGui(SimpleBatteryStorageTileEntity entity, Container container) {
        super(container);
