...
public class AdvancedEnergyStorageContainer extends Container {
    public AdvancedEnergyStorageContainer(IInventory playerInventory, AdvancedBatteryStorageTileEntity storage) {
        for(int i = 0; i < 16; ++i) {
            int row = i % 4;
            int collum = i / 4;
