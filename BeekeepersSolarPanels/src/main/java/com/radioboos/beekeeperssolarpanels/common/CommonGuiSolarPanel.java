...
public class CommonGuiSolarPanel extends GuiContainer {
    public static final ResourceLocation guiTexture = new ResourceLocation("beekeeperssolarpanels", "textures/gui/GuiBeekeepersSolarPanel.png");
    private CommonSolarPanelTileEntity entity;
    public static final int GUI_ID = 0;

    public CommonGuiSolarPanel(CommonSolarPanelTileEntity entity, Container container) {
        super(container);
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        mc.fontRenderer.drawStringWithShadow(inventoryName, xCenter + inventoryNameTextPadding, yCenter + 5, 0x696969);
